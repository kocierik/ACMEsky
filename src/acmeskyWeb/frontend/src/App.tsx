              ...
              <div className="w-full md:w-1/2 md:px-3">
                <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                  ...
                  <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                    Ricevi offerte in tempo reale non appena un volo diventa
                    disponibile.{" "}
                  </p>
                  <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                    <Link
                      to={
                        localStorage.getItem("token") ? "/findTrip" : "/login"
                      }
                      className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-gray-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto"
                    >
                      Prova Gratuitamente
                      <svg
          ...
          <div className="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div className="flex flex-wrap items-center -mx-3">
              <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                <div className="w-full lg:max-w-md">
                  <h2 className="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">
                    Inizia a provare i nostri servizi offerti!
                  </h2>
                  <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                    Non è mai stato così facile cercare un viaggio. I nostri
                    servizi ti aiuteranno con quanto segue:
                  </p>
                  <ul>
                    <li className="flex items-center py-2 space-x-4 xl:py-3">
                      ...
                      <span className="font-medium text-gray-500">
                        Ricerca rapida e completa dei voli
                      </span>
                    </li>
                    <li className="flex items-center py-2 space-x-4 xl:py-3">
                      <svg
                      ...
                      <span className="font-medium text-gray-500">
                        Monitoraggio e tracciamento dei voli in tempo reale
                      </span>
                    </li>
                    <li className="flex items-center py-2 space-x-4 xl:py-3">
                      <svg
                      ...
                      <span className="font-medium text-gray-500">
                        Acquisto tramite il servizio di banking 100% sicuro
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0">
                <img
                  className="mx-auto sm:max-w-sm lg:max-w-full rounded"
                  src={image2}
                  alt="feature image"
                />
              </div>
              ...
              <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                  ...
                  <blockquote className="mt-8 text-lg text-gray-500">
                    Questa è una scelta ovvia se vuoi portare la tua attività al
                    livello successivo. Se stai cercando il set di strumenti
                    definitivo, questo è ciò che fa per te!"
                  </blockquote>
                </div>
                <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                  ...
                  <blockquote className="mt-8 text-lg text-gray-500">
                    "Grazie per aver creato questo servizio. La mia vita è molto
                    più semplice. Grazie per aver realizzato un prodotto così
                    fantastico."
                  </blockquote>
                </div>
                <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                  ...
                  <blockquote className="mt-8 text-lg text-gray-500">
                    "Ricevere questi contenuti è esattamente ciò che volevo.
                    Consiglierei vivamente questo a chiunque."
                  </blockquote>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white">
          <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <div className="flex justify-center mt-8 space-x-6">
              <a
                href="https://github.com/kocierik/ACMEsky"
