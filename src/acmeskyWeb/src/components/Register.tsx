        ...
        <div className="w-full">
          ...
          <div className="mt-5">
            <form action="">
              ...
              <div className="my-6">
                <button type="submit" className="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Registrati</button>
              </div>
              <p className="text-center text-sm text-gray-500"> Hai già un account?
                <Link to="/login"
                  className="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none"> Accedi
                </Link>
              </p>
            </form>
          </div>
