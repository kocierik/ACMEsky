...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
  ...
  VALUES
      ('${AIRLINE_PREFIX}41300', 'AMS', 'FRA', '2025-05-11 08:00:00', '2025-05-11 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}21300', 'FRA', 'BRU', '2025-05-19 08:00:00', '2025-05-19 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}76500', 'LHR', 'FRA', '2025-06-11 08:00:00', '2025-06-11 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}64300', 'FRA', 'LHR', '2025-06-19 08:00:00', '2025-06-19 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}18300', 'LHR', 'FRA', '2025-07-11 08:00:00', '2025-07-11 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}83200', 'FRA', 'LHR', '2025-07-19 08:00:00', '2025-07-19 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}12800', 'LHR', 'FRA', '2025-08-11 08:00:00', '2025-08-11 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}11100', 'FRA', 'LHR', '2025-08-19 08:00:00', '2025-08-19 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}11400', 'LHR', 'FRA', '2025-09-11 08:00:00', '2025-09-11 10:00:00', '${AIRLINE_NAME}', 500.00),
      ('${AIRLINE_PREFIX}11200', 'FRA', 'LHR', '2025-09-19 08:00:00', '2025-09-19 10:00:00', '${AIRLINE_NAME}', 500.00);
