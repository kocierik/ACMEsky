...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
  ...
  VALUES
      ('${AIRLINE_PREFIX}413', 'AMS', 'FRA', '2025-05-11 08:00:00', '2025-05-11 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}213', 'FRA', 'BRU', '2025-05-19 08:00:00', '2025-05-19 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}765', 'LHR', 'FRA', '2025-06-11 08:00:00', '2025-06-11 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}643', 'FRA', 'LHR', '2025-06-19 08:00:00', '2025-06-19 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}183', 'LHR', 'FRA', '2025-07-11 08:00:00', '2025-07-11 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}832', 'FRA', 'LHR', '2025-07-19 08:00:00', '2025-07-19 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}128', 'LHR', 'FRA', '2025-08-11 08:00:00', '2025-08-11 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}111', 'FRA', 'LHR', '2025-08-19 08:00:00', '2025-08-19 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}114', 'LHR', 'FRA', '2025-09-11 08:00:00', '2025-09-11 10:00:00', '${AIRLINE_NAME}', 250.00),
      ('${AIRLINE_PREFIX}112', 'FRA', 'LHR', '2025-09-19 08:00:00', '2025-09-19 10:00:00', '${AIRLINE_NAME}', 250.00);
